...
namespace QuantConnect.Securities
{
    ...
    public class DefaultMarginCallModel : IMarginCallModel
    {
        ...
        protected virtual SubmitOrderRequest GenerateMarginCallOrder(Security security, decimal totalPortfolioValue, decimal totalUsedMargin)
        {
            ...
            var quantity = security.BuyingPowerModel.GetMaximumOrderQuantityForTargetDeltaBuyingPower(
                new GetMaximumOrderQuantityForTargetValueParameters(Portfolio,
                    security,
                    // we expect a reduction so we send in a negative number
                    - deltaAccountCurrency)).Quantity;
